      ...
      <section className=" right-0 top-0 bg-white w-3/4 md:w-[40%] h-screen p-5 pt-10 z-10 fixed">
        ...
        <div>
          ...
          <form action="#" className="mt-10 flex flex-col gap-10">
            <div className="md:flex gap-9">
              ...
              <div className="flex flex-col  text-lg mt-9 md:mt-0">
                ...
                <input
                  type="text"
                  placeholder="First Name"
                  className="border-b-2 border-black outline-none py-1 "
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="text-start bg-gray-800 w-fit text-white p-2 px-5 text-lg rounded-md uppercase border hover:bg-transparent hover:text-black hover:border-2 hover:border-black"
            >
              submit
            </button>
          </form>
